...
#define DELAY_RESET              15          // in mS
  ...
  #define LCD_DB0_PORT           PORTF
  #define LCD_DB0_PIN            0
  #define LCD_DB1_PORT           PORTF
  #define LCD_DB1_PIN            1
  #define LCD_DB2_PORT           PORTF
  #define LCD_DB2_PIN            4
  #define LCD_DB3_PORT           PORTF
  #define LCD_DB3_PIN            5
#endif
#define LCD_DB4_PORT             PORTF       // If using 4 bit omde, yo umust configure DB4-DB7
